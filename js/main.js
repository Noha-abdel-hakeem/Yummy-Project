			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<input class="form-control shadow rounded" onkeyup="validation()" id="name"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control rounded" id="email" placeholder="Enter Your Email">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control rounded" id="phone" placeholder="Enter Your phone">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control rounded" id="age" placeholder="Enter Your Age">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control rounded" type="password" id="password"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control rounded" type="password" id="rePassword"
